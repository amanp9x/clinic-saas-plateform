...
import {
  ...
  useNotifications,
} from '@/hooks/patient/use-notifications';
import { NotificationItem } from '@/components/patient/notification-item';
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Appointment, queue, and record updates.</p>
        </div>
        {hasUnread && (
        ...
        <EmptyState
          ...
          description={
            unreadOnly
              ...
              : "Updates about your appointments, queue, and records will show up here."
          }
        />
      ) : (
        <div className="space-y-3">
