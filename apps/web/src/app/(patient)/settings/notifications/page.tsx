...
const TOGGLES: { key: keyof Omit<NotificationPreferenceInput, 'channel'>; label: string; description: string }[] = [
  ...
  { key: 'prescriptionReady', label: 'Prescription ready', description: 'When a new prescription is issued.' },
  { key: 'reportReady', label: 'Report ready', description: 'When a lab report becomes available.' },
];
