...
import type { NotificationDto, NotificationPreferenceInput, NotificationPreferenceDto, PaginatedResult } from '@clinic/shared';
import { apiFetch } from '@/lib/api-client';

const NOTIFICATIONS_KEY = ['doctor', 'notifications'] as const;
...
export function useUpdateDoctorNotificationPreferences() {
  const queryClient = useQueryClient();
  return useMutation({
